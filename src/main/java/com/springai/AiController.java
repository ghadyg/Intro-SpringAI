...
public class AiController {
    ...
    @GetMapping("test")
    public List<JavaFrameworkRank> test() {
    ...
    public List<quiz> getQuestion(@PathVariable("topic") String topic) {
        var output = chatClient.prompt()
                .user("Give me a question along with 1 right answer and 3 wrong answers about this topic: "+topic)
                .call()
                .entity(new ParameterizedTypeReference<List<quiz>>() {
                });
        return output;
    }
